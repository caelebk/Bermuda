...
class RenderSystem {
  ...
  const std::array<std::string, texture_count> texture_paths = {
      ...
      textures_path("map_interactable/locked_door.png"),
      textures_path("map_interactable/side_doorway.png"),
      textures_path("map_interactable/top_doorway.png"),
      textures_path("map_interactable/bot_doorway.png"),
