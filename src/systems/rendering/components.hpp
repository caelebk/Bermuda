...
enum class SOUND_ASSET_ID {
  ...
  SEAHORSE              = URCHIN + 1,
  TURTLE                = SEAHORSE + 1,
  PRESSURE_PLATE        = TURTLE + 1,
  BOSS_INTRO            = PRESSURE_PLATE + 1,
  CTHULHU_INTRO         = BOSS_INTRO + 1,
  CTHULHU_ANGRY         = CTHULHU_INTRO + 1,
  CTHULHU_SHOCKWAVE     = CTHULHU_ANGRY + 1,
  CTHULHU_DEATH         = CTHULHU_SHOCKWAVE + 1,
  DEATH_SCREEN          = CTHULHU_DEATH + 1,
  END_SCREEN            = DEATH_SCREEN + 1,
...
enum class TEXTURE_ASSET_ID {
  ...
  CTHULHU_OVERLAY      = SHARKMAN_OVERLAY + 1,
  DEATH_OVERLAY        = CTHULHU_OVERLAY + 1,
  ...
  BOSS_DOOR_H          = LOCKED_RED_V + 1,
  BOSS_DOOR_V          = BOSS_DOOR_H + 1,
  DOORWAY_H            = BOSS_DOOR_V + 1,
  ...
  CTHULHU_NORMAL       = LOBSTER_RAM + 1,
  CTHULHU_RAGE         = CTHULHU_NORMAL + 1,
  TENTACLE             = CTHULHU_RAGE + 1,
  FIREBALL             = TENTACLE + 1,
  RAGE_PROJ            = FIREBALL + 1,
  SHOCKWAVE            = RAGE_PROJ + 1,
  BREAKABLE_CRATE      = SHOCKWAVE + 1,
