...
#define KRAB_BOSS_SCALE vec2(10.0)
#define KRAB_BOSS_BOUNDING_BOX vec2(18.f, 14.f)
#define KRAB_BOSS_HEALTH 500.0  // three shot
...
#define KRAB_BOSS_SPOT_RADIUS 250.f
