...
public:
  ...
  template <class Compare> void sort(Compare comparisonFunction) {
    ...
    components =
        std::move(components_new); // note, we use move operations to not create
                                   // unneccesary copies of objects, but memory
