 ...
 * plane. \param Uplane    The raw pixel data for the U plane. \param Upitch The
 * number of bytes between rows of pixel data for the U plane. \param Vplane The
 * raw pixel data for the V plane. \param Vpitch    The number of bytes between
 * rows of pixel data for the V plane.
 *
 *  \return 0 on success, or -1 if the texture is not valid.
 *
