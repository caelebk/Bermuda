...
static int test_ctr() {
  ...
  //	Error += std::is_trivially_default_constructible<glm::quat>::value ? 0 :
  //1; 	Error += std::is_trivially_default_constructible<glm::dquat>::value ? 0 :
  //1; 	Error += std::is_trivially_copy_assignable<glm::quat>::value ? 0 : 1;
