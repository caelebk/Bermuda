...
static int test_asec() {
  ...
  Error += glm::all(glm::equal(glm::asec(glm::dvec1(100000.0)),
                               glm::dvec1(glm::pi<double>() * 0.5), 0.01))
               ? 0
               : 1;
  Error += glm::all(glm::equal(glm::asec(glm::dvec1(-100000.0)),
                               glm::dvec1(glm::pi<double>() * 0.5), 0.01))
...
static int test_acsc() {
  ...
  Error += glm::all(glm::equal(glm::acsc(glm::dvec1(100000.0)), glm::dvec1(0.0),
                               0.01))
               ? 0
               : 1;
  Error += glm::all(glm::equal(glm::acsc(glm::dvec1(-100000.0)),
                               glm::dvec1(0.0), 0.01))
               ? 0
               : 1;
...
static int test_acot() {
  ...
  Error += glm::all(glm::equal(glm::acot(glm::dvec1(100000.0)), glm::dvec1(0.0),
                               0.01))
               ? 0
               : 1;
  Error += glm::all(glm::equal(glm::acot(glm::dvec1(-100000.0)),
                               glm::dvec1(glm::pi<double>()), 0.01))
               ? 0
               : 1;
  Error += glm::all(glm::equal(glm::acot(glm::dvec1(0.0)),
                               glm::dvec1(glm::pi<double>() * 0.5), 0.01))
               ? 0
               : 1;
...
static int test_sech() {
  ...
  Error += glm::all(glm::equal(glm::sech(glm::dvec1(100000.0)), glm::dvec1(0.0),
                               0.01))
               ? 0
               : 1;
  Error += glm::all(glm::equal(glm::sech(glm::dvec1(-100000.0)),
                               glm::dvec1(0.0), 0.01))
               ? 0
               : 1;
  Error +=
      glm::all(glm::equal(glm::sech(glm::dvec1(0.0)), glm::dvec1(1.0), 0.01))
          ? 0
          : 1;
...
static int test_csch() {
  ...
  Error += glm::all(glm::equal(glm::csch(glm::dvec1(100000.0)), glm::dvec1(0.0),
                               0.01))
               ? 0
               : 1;
  Error += glm::all(glm::equal(glm::csch(glm::dvec1(-100000.0)),
                               glm::dvec1(0.0), 0.01))
               ? 0
               : 1;
...
static int test_acsch() {
  ...
  Error +=
      glm::all(glm::equal(glm::acsch(glm::dvec1(100.0)), glm::dvec1(0.0), 0.01))
          ? 0
          : 1;
  Error += glm::all(glm::equal(glm::acsch(glm::dvec1(-100.0)), glm::dvec1(0.0),
                               0.01))
               ? 0
               : 1;
