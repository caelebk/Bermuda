...
static int test_mat2x2_ctor() {
...
#if GLM_LANG & GLM_LANG_CXX11_FLAG
  {
    ...
    A.f = glm::mat2x2(0);
    Error += glm::all(glm::equal(A.i[0], glm::vec2(0), glm::epsilon<float>()))
                 ? 0
                 : 1;

    B.f = glm::mat2x2(1);
    Error +=
        glm::all(glm::equal(B.i[0], glm::vec2(1, 0), glm::epsilon<float>()))
            ? 0
            : 1;
  }
...
static int test_mat2x3_ctor() {
...
#if GLM_LANG & GLM_LANG_CXX11_FLAG
  {
    ...
    A.f = glm::mat2x3(0);
    Error += glm::all(glm::equal(A.i[0], glm::vec3(0), glm::epsilon<float>()))
                 ? 0
                 : 1;

    B.f = glm::mat2x3(1);
    Error +=
        glm::all(glm::equal(B.i[0], glm::vec3(1, 0, 0), glm::epsilon<float>()))
            ? 0
            : 1;
  }
#endif  // GLM_LANG & GLM_LANG_CXX11_FLAG
...
static int test_mat3x4_ctor() {
...
#if GLM_LANG & GLM_LANG_CXX11_FLAG
  {
    ...
    A.f = glm::mat3x4(0);
    Error += glm::all(glm::equal(A.i[0], glm::vec4(0), glm::epsilon<float>()))
                 ? 0
                 : 1;

    B.f = glm::mat3x4(1);
    Error += glm::all(glm::equal(B.i[0], glm::vec4(1, 0, 0, 0),
                                 glm::epsilon<float>()))
                 ? 0
                 : 1;
  }
...
static int test_quat_ctor() {
...
#if GLM_LANG & GLM_LANG_CXX11_FLAG
  {
    ...
    Error +=
        glm::all(glm::equal(A.i, glm::quat(0, 0, 0, 0), glm::epsilon<float>()))
            ? 0
            : 1;

    B.f = glm::quat(1, 1, 1, 1);
    Error +=
        glm::all(glm::equal(B.i, glm::quat(1, 1, 1, 1), glm::epsilon<float>()))
            ? 0
            : 1;
  }
#endif  // GLM_LANG & GLM_LANG_CXX11_FLAG
