...
static int test_mat3x3() {
  glm::dmat3 Mat0(glm::dvec3(0.6f, 0.2f, 0.3f), glm::dvec3(0.2f, 0.7f, 0.5f),
...
static int test_inverse() {
  ...
  {
    glm::mat3 const Matrix(glm::vec3(0.6f, 0.2f, 0.3f),
                           glm::vec3(0.2f, 0.7f, 0.5f),
                           glm::vec3(0.3f, 0.5f, 0.7f));
    glm::mat3 const Inverse  = glm::inverse(Matrix);
    glm::mat3 const Identity = Matrix * Inverse;

    Error += glm::all(glm::equal(Identity[0], glm::vec3(1.0f, 0.0f, 0.0f),
                                 glm::vec3(0.01f)))
                 ? 0
                 : 1;
    Error += glm::all(glm::equal(Identity[1], glm::vec3(0.0f, 1.0f, 0.0f),
                                 glm::vec3(0.01f)))
                 ? 0
                 : 1;
    Error += glm::all(glm::equal(Identity[2], glm::vec3(0.0f, 0.0f, 1.0f),
                                 glm::vec3(0.01f)))
                 ? 0
                 : 1;
  }
...
static int test_ctr() {
  ...
  std::vector<glm::mat3x3> v1{{0, 1, 2, 3, 4, 5, 6, 7, 8},
                              {0, 1, 2, 3, 4, 5, 6, 7, 8}};

  std::vector<glm::mat3x3> v2{{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}},
                              {{0, 1, 2}, {3, 4, 5}, {6, 7, 8}}};
