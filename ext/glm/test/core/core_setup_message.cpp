...
int test_instruction_set() {
  ...
  if (GLM_ARCH & GLM_ARCH_AVX2_BIT) std::printf("AVX2 ");
  if (GLM_ARCH & GLM_ARCH_AVX_BIT) std::printf("AVX ");
...
#if !defined(GLM_FORCE_PLATFORM_UNKNOWN) && \
    !defined(GLM_FORCE_COMPILER_UNKNOWN) && \
    !defined(GLM_FORCE_ARCH_UNKNOWN) && !defined(GLM_FORCE_CXX_UNKNOWN)
