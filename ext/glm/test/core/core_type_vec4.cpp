...
//	return _mm_shuffle_ps(Src, Src, mask<(int(W) << 6) | (int(Z) << 4) |
//(int(Y) << 2) | (int(X) << 0)>::value);
// }
...
static int test_vec4_ctor() {
  ...
  //	Error += std::is_trivially_default_constructible<glm::vec4>::value ? 0 :
  //1; 	Error += std::is_trivially_copy_assignable<glm::vec4>::value ? 0 : 1;
  ...
  /*
          {
                  ...
                  glm::ivec4 const g1 = *reinterpret_cast<glm::ivec4 const*
     const>(&f1);
                  ...
                  glm::ivec4 const g2 = *reinterpret_cast<glm::ivec4 const*
     const>(&f2);
...

          {
                  ...
                  glm::uvec4 const g1 = *reinterpret_cast<glm::uvec4 const*
     const>(&f1);
                  ...
                  glm::uvec4 const g2 = *reinterpret_cast<glm::uvec4 const*
     const>(&f2);
