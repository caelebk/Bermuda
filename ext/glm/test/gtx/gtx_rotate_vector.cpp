...
int test_rotate() {
  ...
  glm::vec3 B = glm::rotate(glm::vec3(1, 0, 0), glm::pi<float>() * 0.5f,
                            glm::vec3(0, 0, 1));
  glm::vec4 C = glm::rotate(glm::vec4(1, 0, 0, 1), glm::pi<float>() * 0.5f,
                            glm::vec3(0, 0, 1));
  ...
  glm::mat4 O =
      glm::orientation(glm::normalize(glm::vec3(1)), glm::vec3(0, 0, 1));
