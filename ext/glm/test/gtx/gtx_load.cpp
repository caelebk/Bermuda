...
#	if GLM_ARCH & GLM_ARCH_SSE_BIT
        ...
        {
                GLM_FUNC_QUALIFIER GLM_CONSTEXPR static vec<4, float, Q>
load(float const* Mem)
                {
...
#	endif//GLM_ARCH & GLM_ARCH_SSE_BIT
        ...
        {
                return detail::init_gentype<genType,
detail::genTypeTrait<genType>::GENTYPE>::identity();
        }
...
int test_vec4_load()
{
        ...
        Error += glm::all(glm::equal(V, glm::aligned_vec4(1.f, 2.f, 3.f, 4.f),
