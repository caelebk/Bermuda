...
int run() {
  ...
  {
    glm::vec4 const A =
        glm::compNormalize<float>(glm::u8vec4(0, 127, 128, 255));
  ...
  {
    glm::vec4 const A =
        glm::compNormalize<float>(glm::i8vec4(-128, -1, 0, 127));
...

  {
    glm::vec4 const A = glm::compNormalize<float>(
        glm::u16vec4(std::numeric_limits<glm::u16>::min(),
...

  {
    glm::vec4 const A = glm::compNormalize<float>(glm::i16vec4(
        std::numeric_limits<glm::i16>::min(), static_cast<glm::i16>(-1),
...
int run() {
  ...
  {
    glm::u8vec4 const A =
        glm::compScale<glm::u8>(glm::vec4(0.0f, 0.2f, 0.5f, 1.0f));
  ...
  {
    glm::i8vec4 const A =
        glm::compScale<glm::i8>(glm::vec4(0.0f, -1.0f, 0.5f, 1.0f));
  ...
  {
    glm::u16vec4 const A =
        glm::compScale<glm::u16>(glm::vec4(0.0f, 0.2f, 0.5f, 1.0f));
  ...
  {
    glm::i16vec4 const A =
        glm::compScale<glm::i16>(glm::vec4(0.0f, -1.0f, 0.5f, 1.0f));
