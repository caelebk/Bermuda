...
int test_string_cast_vector() {
...

  {
    ...
    Error += C2 != std::string("vec4(1.000000, 2.000000, 3.000000, 4.000000)")
                 ? 1
                 : 0;
    ...
    Error += L2 != std::string("dvec4(1.000000, 2.000000, 3.000000, 4.000000)")
                 ? 1
                 : 0;
  }
...
int test_string_cast_matrix() {
  ...
  std::string A2 = glm::to_string(A1);
  Error +=
      A2 != std::string("mat2x2((1.000000, 2.000000), (3.000000, 4.000000))")
          ? 1
          : 0;
...
int test_string_cast_quaternion() {
  ...
  Error += S0 != std::string("quat(1.000000, {2.000000, 3.000000, 4.000000})")
               ? 1
               : 0;
...
int test_string_cast_dual_quaternion() {
  ...
  glm::dualquat Q0 = glm::dualquat(glm::quat(1.0f, 2.0f, 3.0f, 4.0f),
                                   glm::quat(5.0f, 6.0f, 7.0f, 8.0f));
  std::string   S0 = glm::to_string(Q0);
  Error += S0 != std::string(
                     "dualquat((1.000000, {2.000000, 3.000000, 4.000000}), "
